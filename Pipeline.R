...
GSE275938_sce.combined_celltype <- GSE275938_sce.combined@reductions$umap@cell.embeddings %>%
  as.data.frame() %>% cbind(Celltype = GSE275938_sce.combined1@meta.data$celltype)
...
# Epithelium
p <- VlnPlot(subset(GSE275938_sce.combined1, group %in% c('Term infant','BPD') &
                      celltype_lineage == 'Epithelial'), assay = 'SCT', feature='Mitophagy', group.by = 'group', pt.size = 0)+
  geom_boxplot(width=.15,col="black",fill="white")+NoLegend()+
  ggtitle('Epithelial cells')+
  ylab('Estimated score')

write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Mitophagy_Epithelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.23, max(p$data[tail('Mitophagy',1)]+0.08))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.38),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Mitophagy_Endothelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.24, max(p$data[tail('Mitophagy',1)]+0.08))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.41),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Mitophagy_Immune.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.26, max(p$data[tail('Mitophagy',1)]+0.09))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.43),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Mitophagy_Mesenchyme.csv')
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_cGAS_STING_Global.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.23, max(p$data[tail('cGAS-STING',1)]+0.08))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.38),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_cGAS_STING_Epithelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.23, max(p$data[tail('cGAS-STING',1)]+0.06))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.19),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_cGAS_STING_Endothelium.csv')
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_cGAS_STING_Immune.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.23, max(p$data[tail('cGAS-STING',1)]+0.09))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.38),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_cGAS_STING_Mesenchyme.csv')
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_TLR9_Global.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.26, max(p$data[tail('TLR9',1)]+0.10))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.63),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_TLR9_Epithelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.20, max(p$data[tail('TLR9',1)]+0.07))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.45),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_TLR9_Endothelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.24, max(p$data[tail('TLR9',1)]+0.08))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.47),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_TLR9_Immune.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.23, max(p$data[tail('TLR9',1)]+0.1))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.63),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_TLR9_Mesenchyme.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.24, max(p$data[tail('TLR9',1)]+0.09))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.54),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Inflammasome_Global.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.26, max(p$data[tail('Inflammasome',1)]+0.10))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.75),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Inflammasome_Epithelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.22, max(p$data[tail('Inflammasome',1)]+0.04))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.22),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Inflammasome_Endothelium.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.20, max(p$data[tail('Inflammasome',1)]+0.08))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.34),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Inflammasome_Immune.csv')
...
p + 
  ...
  theme(axis.text.y = element_text(size=18,face='bold',colour = 'black'),
        ...
        #panel.border = element_rect(color='black',size=1,fill = NA),
        panel.grid = element_blank())+
  ylim(-0.23, max(p$data[tail('Inflammasome',1)]+0.1))+
  stat_compare_means(comparisons = comparisons,
                     tip.length = 0,
                     label.y=c(0.76),
                     method = 'wilcox.test',
...
write.csv(p$data, file = '/home/fanjie/Yao/GSE275938/GSE275938_sce.combined1_Inflammasome_Mesenchyme.csv')
